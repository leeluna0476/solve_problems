...
fn main() {
    ...
    backtrack(&numbers, &mut result, &mut permuts, (n, m), &mut writer);
}
...
fn backtrack(
    ...
    for i in 0..n {
        ...
        backtrack(numbers, result, permuts, (n, m), writer);
        result.pop();
    }
}
